...
const ExperienceEducation = () => {
  const experience = [
    { role: "Fulfillment Worker", company: "Current Employer", year: "Present" },
    { role: "Baker’s Assistant", company: "Bakery", year: "Previous" },
    { role: "Surf Club Waiter", company: "Surf Club", year: "Previous" },
  ];

  const education = [
    { degree: "Bachelor's in IT (with distinction)", institution: "Your University", year: "Graduated" },
  ];

  return (
    <section id="experience-education" className="p-8 dark:bg-gray-100 dark:text-gray-800">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            {experience.map((exp, index) => (
              <div key={index} className="p-4 bg-white shadow-lg rounded-xl dark:bg-gray-200">
