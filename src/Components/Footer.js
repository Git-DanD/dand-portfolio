...
const Footer = () => {
  return (
    <footer className="dark:bg-gray-100">
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-8 sm:px-6 lg:px-8">
        <div className="border-t border-gray-800 pt-8 sm:flex sm:items-center sm:justify-between">
          <p className="flex flex-wrap justify-center gap-4 text-xs dark:text-gray-800 lg:justify-end">
          ...
          <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
            <li>
              <a
                ...
                rel="noreferrer"
                target="_blank"
                className="dark:text-gray-800 transition hover:opacity-75"
              >
